...
namespace Assignment_4._2
{
    class Assignment4_Block
    {
        static void Main(string[] args)
        {
            ...
            char[] options = new char[] { 'A', 'B', 'X' };

            account.promptAccount(ref accts);//method to fill the accounts array with user input
            ...
            while ((ch = char.ToUpper(Input.promptChar(prompt, errormsg, options))) != 'X')
            {
                Console.WriteLine();
